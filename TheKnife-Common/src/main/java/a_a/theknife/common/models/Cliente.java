...
public class Cliente extends Utente implements Serializable{
    public Cliente(String nome, String cognome, String username, String eMail, String password, LocalDate dataNascita, String citta, String nazione) throws InvalidEMailException, InvalidPasswordException{
