...
public class Recensione implements Serializable{
     ...
     */
    public Recensione(int valutazione, String testo) throws InvalidRatingException, TextTooLongException{
     ...
     * @throws <code>TextTooLongException</code>
     */
    public Recensione(int id, int valutazione, String testo, LocalDate ultimaModifica, Risposta risposta)  throws InvalidRatingException, TextTooLongException{
        if(valutazione < 1 || valutazione > 5){
            throw(new InvalidRatingException());
        }
        if(testo.length() > LUNGHEZZA_MASSIMA_TESTO){
