...
public class Recensione implements Serializable{
     ...
     */
    public Recensione(String autore, int valutazione, String testo, int ristorante) throws InvalidRatingException, TextTooLongException{
     ...
     * @throws <code>TextTooLongException</code>
     */
    public Recensione(int id, String autore, int valutazione, String testo, LocalDate ultimaModifica, Risposta risposta, int ristorante)  throws InvalidRatingException, TextTooLongException{
        if(valutazione < 1 || valutazione > 5){
            throw(new InvalidRatingException());
        }
        if(testo.length() > LUNGHEZZA_MASSIMA_TESTO){
