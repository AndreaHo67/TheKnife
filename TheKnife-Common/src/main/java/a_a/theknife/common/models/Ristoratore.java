...
public class Ristoratore extends Utente implements Serializable{
    public Ristoratore(String nome, String cognome, String username, String eMail, String password, LocalDate dataNascita, String citta, String nazione) throws InvalidUsernameException, InvalidEMailException, InvalidPasswordException {
