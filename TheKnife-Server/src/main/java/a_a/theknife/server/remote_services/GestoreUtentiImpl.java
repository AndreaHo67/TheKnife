...
public class GestoreUtentiImpl extends UnicastRemoteObject implements GestoreUtenti{
    private final String url_db = CredenzialiDatabase.getDbUrl();
    private final String utente_db = CredenzialiDatabase.getDbUser();
    private final String password_db = CredenzialiDatabase.getDbPassword();
    ...
    public synchronized void modificaPassword(Utente utente, String nuovaPassword) throws RemoteException, InvalidPasswordException{
        ...
        try(Connection connection = DriverManager.getConnection(url_db, utente_db, password_db);
            ...
            utente.setPassword(nuovaPassword); // dopo l'hashing salvato sul db, salvo la nuovaPassword hashata all'istanza Utente
        } catch (SQLException e) {
